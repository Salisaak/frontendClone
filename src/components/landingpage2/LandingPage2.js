  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{fontFamily: 'CharlieDisplay', fontSize: 20, fontWeight: 500 }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p style={{fontFamily: 'CharlieDisplay', fontSize: 20, fontWeight: 500, paddingTop: 20 }}>
                Atlassian Community
              </p>
              <p style={{fontFamily: 'CharlieDisplay', fontSize: 15, paddingTop: 20, fontWeight: 500 }}>
              ...
              >
                <div style={{fontFamily: 'CharlieDisplay', flex: 0.4, color: "blue" }}>Search Forum</div>
                <div style={{fontFamily: 'CharlieDisplay', flex: 0.4, color: "blue" }}>Join Community</div>
              </div>
            </div>
          </div>
        </div>
